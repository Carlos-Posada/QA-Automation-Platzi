describe('Esperando por elementos', () => {
	...
	it('Espera por un elemento', () => {
		//a pesar de que el tiempo es el mismo , es un timeout si lo encuentra antes seguirá avanzando no esperara los 6 segundos siempre
		cy.get('.ButtonLogin-cta', { timeout: 6000 })
	})

	it('Espera por un elemento y hacer una asersion', () => {
		//a pesar de que el tiempo es el mismo , es un timeout si lo encuentra antes seguirá avanzando no esperara los 5 segundos siempre
		...
		// esto  no sirve  ,recuerda que hay que reintentar el comando con las asersiones no solo las aserciones
