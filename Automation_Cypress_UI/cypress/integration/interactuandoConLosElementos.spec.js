describe('Interactuando con los elementos', () => {
	...
	//Interacción con los dropdowns
	it('interactuando con los dropdwon(select)', function(){
		cy.visit('https://itera-qa.azurewebsites.net/home/automation')
		cy.get('.custom-select').select(9)
	...
	it('Interactuando con data picker', () => {
		...
		// //Mi forma, no recomendada por el force true
		// cy.get('#mat-input-0').click({force:true}).type('11/03/2022')

		//forma profe, recomendada ya que el elemento input esta encapsulado en datepicker-overview-example
		cy.get('datepicker-overview-example').find('input').eq(0).click({force:true}).type('07/02/2023{enter}')
